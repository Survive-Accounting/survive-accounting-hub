...
export const IGNORED_ROUTES: Record<string, string> = {
  ...
  "branding_.thumbnails.tsx": "the thumbnail system — site thumbnails + social covers, four variants, any campus (AdminGate, noindex)",
  "branding_.social.tsx": "the social kit — master avatar, YouTube banner, cover template, campus bolts (AdminGate, noindex)",
  ...
  "admin.growth.v2.tsx": "Campaign command center — campus feed with bolt, metrics, scrape, and the DM board (admin, noindex)",
  "admin.growth.v3.tsx": "King's playground — a copy of the v2 command center where his fast-track changes land first (admin, noindex)",
  ...
  "admin.growth.coldoutreach.team.tsx": "VA team — the roster (add a VA, copy their private link, activate) and light per-VA activity, no pay (admin, noindex)",
  "admin.growth.coldoutreach.va-preview.tsx": "Preview as a VA — act as a VA from your admin account to see their stripped view for a chosen team (admin, noindex)",
  ...
  "admin.learn.tsx": "/admin/learn (AdminGate, noindex) — drag to reorder the posted videos, normalize audio, sync offset, good / needs-redo with a why (2026-09-16)",
  "v4.stitch-room.tsx": "V4 Stitch Room (AdminGate, noindex) — the popout punch-in stitches open in: live build, trims, downloads, post queue, stats and pay ledger (2026-09-15)",
  "v4.demo-lens.tsx": "V4 Demo lens (AdminGate, noindex) — any app page in a vertical window, wheel zoom + drag to swim, for filming demos (2026-09-15)",
  "v4.breathers.tsx": "V4 Breathers (AdminGate, noindex) — the same breather authoring, reached from /v4 (2026-09-14)",
  "playground.tsx": "internal (noindex) — turns gamer mode on in this browser and links into the site (2026-09-15)",
