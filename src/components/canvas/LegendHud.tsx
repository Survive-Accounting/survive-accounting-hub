...
// Lives in the drawer's Key panel (always docked); hidden in film mode + clean
// screen. Compact by design: legible at a glance, no scrolling.
import { useState } from "react";
import { Boxes, ChevronDown, ChevronRight, Clapperboard, Film, Flag, Home, Layers3, MessageCircleQuestion, Scissors, SquareDashed, StickyNote, TrafficCone } from "lucide-react";
...
export function LegendHud({ docked = false }: {
   ...
   *  no floating chrome. The only mode wired today. */
  docked?: boolean;
}) {
  return (
    <div
