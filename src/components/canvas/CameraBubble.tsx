  ...
  return (
    ...
    >
      <div
        ...
        style={{
          borderRadius: prefs.shape === "circle" ? "9999px" : 16,
          border: `2px solid ${NEON.pink}`,
          boxShadow: `0 0 0 1px rgba(0,0,0,0.6), 0 0 24px -4px ${NEON.pink}`,
          background: "#000",
        }}
      ...
      <div
        ...
        style={{ background: `linear-gradient(135deg, transparent 50%, ${NEON.pink} 50%)`, borderBottomRightRadius: prefs.shape === "circle" ? 9999 : 16 }}
