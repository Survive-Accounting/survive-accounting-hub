...
export function OutroCard({ scale = 1, transparent = false, playKey = 0 }:
  { scale?: number; transparent?: boolean; playKey?: number }) {
  return (
    <Stage scale={scale} transparent={transparent}>
      ...
      <div key={playKey} style={{ display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", fontFamily: "'Rubik', system-ui, sans-serif" }}>
        ...
        <div className="sa-outro-tag" style={{ marginTop: 48, fontWeight: 600, fontSize: Math.round(WORD * 0.28), color: BRAND_CREAM, lineHeight: 1 }}>Only what&rsquo;s on your exam.</div>
