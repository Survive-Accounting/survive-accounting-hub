// /v3/queue — THE QUEUE LIST. Until 2026-09-10 this was the /v3 home; the map is now (Lee: "make
// the cram map the home page of /v3"). Same rows, same buttons — reached from the map header.
//
...
export const Route = createFileRoute("/v3/queue")({
  component: V3Queue,
