...
export const Route = createFileRoute("/waitlist")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://surviveaccounting.com/waitlist" },
      // ARCHIVED 2026-08-13: this WAS the homepage until /landing was promoted to "/". Kept live
      // so the Fall-2026 waitlist framing and its /order CTA still work, but noindex'd so it can't
      // compete with the real homepage for the same queries. The Organization JSON-LD below moved
      // to the new "/" — it must exist on exactly one page.
      { name: "robots", content: "noindex" },
    ],
    links: [{ rel: "canonical", href: "https://surviveaccounting.com/waitlist" }],
  }),
