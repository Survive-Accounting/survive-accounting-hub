// /admin/growth/v2 — THE CAMPAIGN COMMAND CENTER.
//
// A searchable feed of campuses you scroll down. Each is a card: a bolt in the campus colours (grey
// until it has contacts), the campus numbers, a Scrape-contacts button, and — when expanded — the
// councils as accordions you open one at a time to work the DMs. The DM machinery (Copy DM, sent,
// clicks, reply thread) is the same ContactRow the coldoutreach board uses.
...
export const Route = createFileRoute("/admin/growth/v2")({ component: GrowthV2Page });
