// /v3/$topic/$set/blast-off/improve — STEP 5. Improve Process.
//
...
// body is components/v3/improve/ImprovePage.tsx — a stub today; the next build replaces that
// component and leaves this route as it is.
//
...
export const Route = createFileRoute("/v3/$topic/$set/blast-off/improve")({
  ...
  head: () => ({ meta: [{ title: "📈 Improve Process — Blast Off" }, { name: "robots", content: "noindex" }] }),
});
