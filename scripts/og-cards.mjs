...
const NAVY = "#14213D", CREAM = "#F5EFE6", WHITE = "#FFFFFF", GOLD = "#FCA311";
// The house mark — one hue, two values. A card for a real campus passes that campus's own pair.
const LIT = "#006BA6", SHADE = "#00456E";
const W = 1200, H = 630, MARGIN = 60;

const esc = (s) => s.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;");

/** The bolt as an SVG group, `h` px tall with its top-left at (x, y). */
function bolt(x, y, h, c1 = LIT, c2 = SHADE) {
  const scale = h / VB.h;
