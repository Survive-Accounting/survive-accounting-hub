// One-shot: apply migration/supabase-migrations/20260830_1600_rep_program_v2.sql to the LIVE
...
const sql = readFileSync("migration/supabase-migrations/20260830_1600_rep_program_v2.sql", "utf8");
