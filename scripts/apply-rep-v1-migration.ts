// One-shot: apply migration/supabase-migrations/20260826_0900_campus_rep_v1.sql to the LIVE
...
const sql = readFileSync("migration/supabase-migrations/20260826_0900_campus_rep_v1.sql", "utf8");
