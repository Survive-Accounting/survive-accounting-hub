-- 0015: Idempotent seed for templates and broadcasts (recovers from prior partial runs).
-- Safe to re-run; only fills gaps.

-- Make seeding repeatable: enforce composite uniqueness used by upserts below.
