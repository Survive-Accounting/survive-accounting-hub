...
drop policy if exists "anon all concepts" on public.concepts;
create policy "anon all concepts" on public.concepts for all to anon using (true) with check (true);
drop policy if exists "anon all concept_mappings" on public.concept_mappings;
create policy "anon all concept_mappings" on public.concept_mappings for all to anon using (true) with check (true);
drop policy if exists "anon all ceq_dictation_sessions" on public.ceq_dictation_sessions;
...
drop policy if exists "anon all ceq_dictation_segments" on public.ceq_dictation_segments;
...
drop policy if exists "auth all ceq_dictation_segments" on public.ceq_dictation_segments;
