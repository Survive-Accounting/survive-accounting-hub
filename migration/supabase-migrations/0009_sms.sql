...
create table if not exists public.sms_conversations (
  ...
  major text,
  sentiment text,
  status text not null default 'active',  -- active | opted_out | closed
...
-- RLS: playground — dashboard (anon) reads everything, writes outbox/replies.
...
-- Every-minute outbox processor. The secret below must match the
-- CRON_SECRET secret set in Lovable (already generated for you).
